...
from eval_utils_counterfact import compute_rewrite_quality_counterfact_medical
...
def main(
    ...
    ds = ds_class('./evaluation/data/medical/', size=dataset_size_limit, tok=tok)
    ...
    with open(os.path.join(run_dir, 'gen.json'), "w") as f:
